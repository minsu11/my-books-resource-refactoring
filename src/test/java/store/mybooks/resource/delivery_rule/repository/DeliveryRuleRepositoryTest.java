...
class DeliveryRuleRepositoryTest {
    ...
    void setUp() {
        ...
        DeliveryRule deliveryRule1 =
                new DeliveryRule(1, deliveryNameRule, "test1", 1000, 1000, LocalDate.of(2023, 12, 31), 1);
        DeliveryRule deliveryRule2 =
                new DeliveryRule(2, deliveryNameRule, "test2", 1000, 1000, LocalDate.of(2023, 12, 31), 1);
    ...
    void given_whenGetDeliveryRuleList_thenReturnDeliveryRuleResponseList() {
        DeliveryRuleName deliveryNameRule = new DeliveryRuleName("test");
        DeliveryRuleResponse deliveryRule1 =
                new DeliveryRuleResponse(1, deliveryNameRule.getId(), "test1", 1000, 1000, LocalDate.of(2023, 12, 31),
                        1);
        DeliveryRuleResponse deliveryRule2 =
                new DeliveryRuleResponse(2, deliveryNameRule.getId(), "test2", 1000, 1000, LocalDate.of(2023, 12, 31),
                        1);
    ...
    void givenDeliveryRuleName_whenGetDeliveryRule_thenReturnDeliveryRuleResponse() {
        DeliveryRuleName deliveryNameRule = new DeliveryRuleName("tests");
        deliveryRuleNameRepository.save(deliveryNameRule);
        DeliveryRule deliveryRule =
                new DeliveryRule(3, deliveryNameRule, "test1", 1000, 1000, LocalDate.of(2023, 12, 31), 1);
        deliveryRuleRepository.save(deliveryRule);

        DeliveryRuleResponse expected =
                new DeliveryRuleResponse(3, deliveryNameRule.getId(), "test1", 1000, 1000, LocalDate.of(2023, 12, 31),
                        1);

        Optional<DeliveryRuleResponse> optionalResult =
                deliveryRuleRepository.getDeliveryRuleByName(deliveryNameRule.getId());
